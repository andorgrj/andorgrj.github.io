...
yaml fájlból
egyszerre több konténer indítható, egy alkalmazást több konténer valósít meg és az egész egy parancsal indítható
...
Állapot eltárolására hozzuk létre a köteteket
...
Ezen kívül csatolhatunk is létező, fizikai helyeket a számítógépünkről.
