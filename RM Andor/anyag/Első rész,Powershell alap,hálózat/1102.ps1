...
halozati topologia retegei : core, switch 
dhcp-t disztribucios szintre kell bekötni

access layer

router ad dhcp-t

subnet létrehozáds s dhcp-n belül 

vlan --> egy hálozaton belül több logikai cimzest hasznalhatok
